...
import Demo_code from './target?raw'
...
<code src="./basic.tsx">Basic</code>
<code src="./on-change.tsx">Callback</code>
<code src="./target.tsx">Container to scroll.</code>
<code src="./debug.tsx" debug>debug</code>
